...
#Belichtungszeit bei 45000 für die Fits bestimmen
#Erstellt die entsprechende Belichtungszeit und ordnet sie der Parameter ID zu-> siehe Konsole
...
df_belichtung = pd.DataFrame(id_and_time, columns=["Parameter_ID", "Belichtungszeit_ms"])
